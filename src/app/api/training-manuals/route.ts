...
export async function POST(req: NextRequest) {
  ...
  const item = await (prisma as any).trainingManual.create({
    data: {
      titleEn,
      titleBn,
...
export async function PUT(req: NextRequest) {
  ...
  const item = await (prisma as any).trainingManual.update({
...
export async function DELETE(req: NextRequest) {
  ...
  await (prisma as any).trainingManual.delete({ where: { id } });
